...
def constrast_temp():
    ...
    class ContrastiveLoss(nn.Module):
        ...
        def forward(self, inputs_embeds):
            ...
            positive_mask = torch.eye(L).bool().to(inputs_embeds.device)
    ...
    # Modify your model's forward function to also return inputs_embeds
    ...
    def train_one_epoch(args, model, criterion, contrastive_criterion, data_loader, optimizer, device, epoch, config,
        ...
        for step, (src_input, tgt_input) in enumerate(data_loader):
            # ... existing code ...
            out_logits, output, inputs_embeds = model(src_input, tgt_input)
            # ... existing code ...
            contrast_loss = contrastive_criterion(inputs_embeds)
